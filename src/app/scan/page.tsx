      ...
      <div className="relative h-[70vh] bg-black overflow-hidden">
        ...
        {!imagePreview && (
          <div className="absolute inset-0 flex flex-col items-center justify-end pb-8">
            <div className="w-64 h-64 border-4 border-white/30 rounded-full mb-8"></div>
            <p className="text-white/80 mb-4">Position the plant within the frame</p>
          </div>
        )}
        ...
        {isScanning && (
          <div className="absolute inset-0 bg-black/70 flex flex-col items-center justify-center">
            ...
            <p className="text-white text-lg">Analyzing plant...</p>
      ...
      <div className="p-4">
        {!imagePreview && !isScanning && (
          <button
            ...
            className="w-16 h-16 rounded-full bg-white border-4 border-green-100 mx-auto flex items-center justify-center -mt-8 shadow-lg hover:scale-105 transition-transform"
            disabled={isScanning}
          >
        ...
        {plantInfo && (
          <div className="mt-6 space-y-6">
            <div className="bg-white rounded-xl p-5 shadow-sm border border-gray-100">
              ...
              <p className="text-green-600 italic">{plantInfo.scientificName}</p>
              <div className="mt-4 space-y-3">
                <div className="flex items-center">
                  <Leaf className="h-5 w-5 text-green-500 mr-2" />
                  <span className="text-gray-700">Age: {plantInfo.age}</span>
                </div>
                <div className="flex items-center">
                  <Calendar className="h-5 w-5 text-green-500 mr-2" />
                  <span className="text-gray-700">Harvest: {plantInfo.harvestTime}</span>
                </div>
                <div className="flex items-center">
